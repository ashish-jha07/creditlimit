...
@Component({
  selector: 'app-downloadreportdetails',
  templateUrl: './downloadreportdetails.component.html',
  styleUrls: ['./downloadreportdetails.component.scss']
})
export class DownloadreportdetailsComponent implements OnInit {
  SalesRemark: string = '';
  WOSRemark: string = '';
